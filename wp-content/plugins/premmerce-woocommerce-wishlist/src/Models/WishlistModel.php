...
class WishlistModel
{
    ...
    {
        switch ($type) {
            case 'day':     $interval = array('type' => 'DAY' ,   'value' => 1);
            break;
            case 'day3':    $interval = array('type' => 'DAY' ,   'value' => 3);
            break;
            case 'week':    $interval = array('type' => 'DAY' ,   'value' => 7);
            break;
            case 'month':   $interval = array('type' => 'MONTH' , 'value' => 1);
            break;
            case 'month3':  $interval = array('type' => 'MONTH' , 'value' => 3);
            break;
            case 'month6':  $interval = array('type' => 'MONTH' , 'value' => 6);
            break;
            case 'year':    $interval = array('type' => 'YEAR' ,  'value' => 1);
            break;
